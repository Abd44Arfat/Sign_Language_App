...
class SignupCubit extends Cubit<SignupState> {
  ...
  void execute({required SignupReqParams params, required SignupUsecase usecase}) async {
  emit(SignupLoading());
  ...
  try {
    ...
    result.fold(
      ...
      (data) {
        ...
        emit(SignupSuccess(message: data.message)); // Ensure you pass the user's name if available
        btnKey.currentState!.animateReverse();
      },
    );
  } catch (e) {
