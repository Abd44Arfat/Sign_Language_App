...
class EditProfileCubit extends Cubit<EditProfileState>{
 ...
 // final EditInfoUseCase editInfoUseCase;
  ...
  Future<void> updateUserInformation({required EditInfoUseCase usecase , required EditInformationEntity entity }) async{
    ...
    try{
      ...
      result.fold((error) {
        ...
        emit(EditProfileSuccess(msg: 'User information updated successfully!', name: data.name ?? entity.name , email: data.email ?? entity.email ));
        btnKey.currentState!.animateReverse();
      });
