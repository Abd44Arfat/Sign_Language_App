...
import 'package:sign_lang_app/features/learn/presentation/quizs.dart/widgets/quiz_view_body.dart';class QuizView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      ...
      child: Scaffold(
        ...
        body: CustomStack(child: QuizViewBody(levelId: levelId)), // Pass levelId to QuizViewBody
      ),
    );
  }
}